...
​     BYOVD 攻击是攻击对抗和投机攻击常用的一种方法。为了证明此观点，我使用使用此类攻击的家族、和相关的cve、相关的驱动的表格说明一下：
...
![](L:\pages\2022-05-15_pic\image3-1.png)
